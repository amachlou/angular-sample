...
const routes: Routes = [
  ...
  {
    /*
    Property 'ProductDetailsComponent' 
    does not exist on type 'typeof 
    import("c:/DEV/myworkspace/angular/angular-essentials/src/app/app.module")'.ts(2339)
    */
    path: 'products/:id',
    loadComponent: () => import('./pages/products/product-details/product-details.component').then(m => m.ProductDetailsComponent),
    title: 'Products Details'
  },
  {
    path: 'products',
    loadChildren: () => import('./pages/products/products-list/products.module').then(m => m.ProductsModule),
    title: 'Products'
  },
  {
    path: '',
